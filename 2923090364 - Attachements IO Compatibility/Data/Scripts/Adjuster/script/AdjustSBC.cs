                    ...
                    foreach (var action in block.BlockActions)
                    {
                        ...
                        switch (action.Action)
                        {
                            ...
                            case BlockMod.ChangeLaserMaxRange:
                                ...
                                break;
                            case BlockMod.ChangeSafetyDetach:
                                (BlockDef as MyMotorAdvancedStatorDefinition).SafetyDetach = action.Value;
                                break;
                            case BlockMod.ChangeSafetyDetachMax:
                                (BlockDef as MyMotorAdvancedStatorDefinition).SafetyDetachMax = action.Value;
                                break;
