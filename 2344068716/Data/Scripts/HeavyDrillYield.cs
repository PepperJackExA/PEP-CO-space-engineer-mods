...
namespace HeavyDrillYield
{                                                   // Add/replace your drill subtype IDs here
    ...
    public class HeavyDrillYield : MyGameLogicComponent
    {
        ...
        public override void UpdateBeforeSimulation10()
        {
            ...
            else
            {
                ...
                if (CurrentStoneLevel > LastStoneLevel)
                { // If ore level has increased, adds additional ore of that type, based on YieldMultiplier
                ...
                if (CurrentSulfurLevel > LastSulfurLevel)
                { // If ore level has increased, adds additional ore of that type, based on YieldMultiplier
                ...
                if (CurrentIronLevel > LastIronLevel)
                { // If ore level has increased, adds additional ore of that type, based on YieldMultiplier
                ...
                if (CurrentNickelLevel > LastNickelLevel)
                { // If ore level has increased, adds additional ore of that type, based on YieldMultiplier
                ...
                if (CurrentCobaltLevel > LastCobaltLevel)
                { // If ore level has increased, adds additional ore of that type, based on YieldMultiplier
                ...
                if (CurrentSiliconLevel > LastSiliconLevel)
                { // If ore level has increased, adds additional ore of that type, based on YieldMultiplier
                ...
                if (CurrentSilverLevel > LastSilverLevel)
                { // If ore level has increased, adds additional ore of that type, based on YieldMultiplier
                ...
                if (CurrentGoldLevel > LastGoldLevel)
                { // If ore level has increased, adds additional ore of that type, based on YieldMultiplier
                ...
                if (CurrentPlatinumLevel > LastPlatinumLevel)
                { // If ore level has increased, adds additional ore of that type, based on YieldMultiplier
                ...
                if (CurrentUraniumLevel > LastUraniumLevel)
                { // If ore level has increased, adds additional ore of that type, based on YieldMultiplier
                ...
                if (CurrentCopperLevel > LastCopperLevel)
                { // If ore level has increased, adds additional ore of that type, based on YieldMultiplier
                ...
                if (CurrentLithiumLevel > LastLithiumLevel)
                { // If ore level has increased, adds additional ore of that type, based on YieldMultiplier
                ...
                if (CurrentBauxiteLevel > LastBauxiteLevel)
                { // If ore level has increased, adds additional ore of that type, based on YieldMultiplier
                ...
                if (CurrentTitaniumLevel > LastTitaniumLevel)
                { // If ore level has increased, adds additional ore of that type, based on YieldMultiplier
                ...
                if (CurrentTantalumLevel > LastTantalumLevel)
                { // If ore level has increased, adds additional ore of that type, based on YieldMultiplier
                ...
                if (CurrentNiterLevel > LastNiterLevel)
                { // If ore level has increased, adds additional ore of that type, based on YieldMultiplier
                ...
                if (CurrentOilSandLevel > LastOilSandLevel)
                { // If ore level has increased, adds additional ore of that type, based on YieldMultiplier
                ...
                if (CurrentCoalLevel > LastCoalLevel)
                { // If ore level has increased, adds additional ore of that type, based on YieldMultiplier
                ...
                if (CurrentIceLevel > LastIceLevel)
                { // If ore level has increased, adds additional ore of that type, based on YieldMultiplier
