...
namespace ModAdjuster
{
    public class BlockDefinitions
    {
        public List<BlockDef> Definitions = new List<BlockDef>()
        {
            ...
            new BlockDef()
            {
                BlockName = "MyObjectBuilder_WindTurbine/LargeBlockWindTurbine", // Name of the block to modify. Format is "MyObjectBuilder_Type/Subtype" in the same format as BlockVariantGroups
                BlockActions = new[] // List of modifications to make. Can be as many or few as desired
                {
                    ...
                    //new BlockAction
                    //{
                    //    A1sction = DisableBlockDefinition // Block will still exist in world and can be built from projections unfortunately
                    //},
                    //new BlockAction
                    //{
