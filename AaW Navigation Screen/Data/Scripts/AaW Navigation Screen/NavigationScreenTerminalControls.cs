    ...
    public class NavigationScreenTerminalControls
    {
        ...
        static void CreateControls()
        {
...

            {
                ...
                c.Getter = (b) => b?.GameLogic?.GetAs<NavigationScreenLogic>()?.NavigationScreenChevronScale ?? 1;
...

            {
                ...
                c.Getter = (b) => b?.GameLogic?.GetAs<NavigationScreenLogic>()?.NavigationScreenChevronStrength ?? 10;
